...
#ifdef ESP32
  _servoRotary.writeMove(angle, acceleration);
#elif ESP8266
...
#ifdef ESP32
  _servoShoulder.writeMove(angle, acceleration);
#elif ESP8266
...
#ifdef ESP32
  _servoElbow.writeMove(angle, acceleration);
#elif ESP8266
...
#ifdef ESP32
  _servoGlipper.writeMove(angle, acceleration);
#elif ESP8266
